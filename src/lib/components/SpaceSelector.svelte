  ...
  {:else}
    <ul class="flex flex-col gap-2 items-center py-2">
      {#each $spaces as space}
        <li>
          <button
            class="w-10 h-10 flex items-center justify-center rounded-full bg-white border-2 border-base-300 hover:bg-base-200 focus:bg-base-200 transition outline-none shadow-sm"
            type="button"
          ...
          >
            <span class="w-8 h-8 flex items-center justify-center rounded-full font-bold text-base-content text-sm select-none" style="color: #222;">
